...
import { extensionCommand } from '../ui/commands/extensionCommand.js';
...
vi.mock('../ui/commands/extensionCommand.js', () => ({
  extensionCommand: { name: 'extension', description: 'Mock Extension' },
}));
  ...
  describe('when using default production loader', () => {
    ...
    describe('loadCommands', () => {
      it('should load the built-in commands into the command tree', async () => {
        ...
        expect(commandNames).toContain('extension');
      });
